...
function MainPage() {
  ...
  // pdf to text parser, xu ly file upload: co the bo
  ...
  return (
    <>
      ...
      >
        <Text fontSize='md'>{coverLetterCount?.toLocaleString()} QA Generated! 🎉</Text>
      </Box>
      <BorderBox>
        <form
        ...
        >
            ...
            <Heading size={'md'} alignSelf={'start'} mb={3} w='full'>
               Info {isCoverLetterUpdate && <Code ml={1}>Editing...</Code>}
            </Heading>
            ...
            <>
              ...
              <FormControl isInvalid={!!formErrors.description}>
                <Textarea
                  id='description'
                  borderRadius={0}
                  placeholder='copy & paste the learning objectives in any language'
...
{/*                <FormControl display='flex' alignItems='center' mt={3} mb={3}>
              ...
              <HStack alignItems='flex-end' gap={1}>
                <Button
                  ...
                  type='submit'
                >
                  {!isCoverLetterUpdate ? 'Create' : 'Create New Cover Letter'}
                </Button>
