...
const gptConfig = {
  ...
  Your questions and answers should be crafted in a clear, accessible language suitable for educational purposes.`,
  ...
  Craft each question and answer in a clear and lively language that is accessible and appealing to students.`,
  ideasForCoverLetter:
    "You are an educational content generator. Given information about a course, its lessons, and key learning points, you will generate a set of 16 questions and answers.",
};
